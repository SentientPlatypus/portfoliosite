         ...
         if (response.ok) {
           ...
           setLeetcodeData({
             matchedUser: {
               ...
               profile: {
                 ranking: Math.max(1000000 - (data.solvedProblem * 4000), 50000), // Estimate ranking based on problems solved
                 reputation: 0
               }
             }
           });
  ...
  return (
    <Widget
      icon={
       ...
       title="LeetCode"
       description={`${stats.total} solved • Rank ${formatRanking(ranking)}`}
      isExpanded={isExpanded}
      onToggleExpand={onToggleExpand}
    >
      <div className="space-y-2">
